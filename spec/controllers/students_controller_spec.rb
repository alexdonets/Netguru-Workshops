...
RSpec.describe StudentsController do
  ...
  describe 'PUT #update' do
    ...
    let(:last_name) { 'White' }
    let(:birthday) { '1995-10-20' }
    let!(:params) do
      { id: student.id, student: { first_name: first_name, birthday: birthday } }
    end
    ...
    context 'success' do
      ...
      context 'updates student' do
        ...
        it { is_expected.to change{ student.reload.birthday }.to(birthday.to_date) }
      end
    end
